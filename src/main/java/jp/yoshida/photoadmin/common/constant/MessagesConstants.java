...
public class MessagesConstants {
    ...
    public static final String ERROR_FILE_IS_NOT_IMAGE
            = "{jp.yoshida.photoadmin.controller.form.validation.ImageFile.message}";

    public static final String ERROR_FILE_NAME_IS_EMPTY
            = "{jp.yoshida.photoadmin.controller.form.validation.MaxFileNameLength.message.empty}";

    public static final String ERROR_FILE_NAME_LENGTH_EXCEEDED
            = "{jp.yoshida.photoadmin.controller.form.validation.MaxFileNameLength.message}";

    public static final String ERROR_FILE_SIZE_EXCEEDED
            = "{jp.yoshida.photoadmin.controller.form.validation.MaxFileSize.message}";
